...
class Lyrics extends Component {
    ...
    render() {
        ...
        console.log(track)
        if(track & lyrics === undefined || Object.keys(track).length === 0 || Object.keys(lyrics).length === 0){
          return  <Spinner />
        } else {
            return (
                <React.Fragment>
                    ...
                    <ul className="list-group mt-3">
                        ...
                        {/*<li className="list-group-item">*/}
                        {/*    <strong>Genere </strong> : {track.primary_genres.music_genre_list[0].music_genre.music_genre_name}*/}
                        {/*</li>*/}
                        <li className="list-group-item">
